    ...
    <div class="py-6">
        ...
        <nav class="bg-gray-50 px-6 py-3 text-gray-700">
            <ol class="list-reset flex text-sm">
                ...
                <li><span class="mx-2">/</span></li>
                <li class="text-gray-500">{{ __('Edit Category') }}</li>
            </ol>
        </nav>
        ...
        <main class="p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">{{ __('Edit Category') }}</h1>
                    <p class="text-gray-600 mt-1">{{ __('Update Category Details') }}</p>
                </div>
                <div>
                ...
                <div class="bg-white rounded-lg shadow p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <x-textarea id="description" class="block mt-1 w-full" rows="4" name="description"
                            autocomplete="description">{{ old('description', $category->description) }}</x-textarea>
