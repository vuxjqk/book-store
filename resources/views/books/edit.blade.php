    ...
    <div class="py-6">
        ...
        <div class="bg-gray-50 px-6 py-3 text-gray-700">
            <ol class="list-reset flex text-sm">
                ...
                <li><span class="mx-2">/</span></li>
                <li class="text-gray-500">Chỉnh sửa sách</li>
            </ol>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Chỉnh sửa sách</h1>
                    <p class="text-gray-600 mt-1">Cập nhật thông tin chi tiết về sách</p>
                </div>
                                    ...
                                    @foreach ($languages as $language)
                                        <div class="flex items-center gap-2 mt-2">
                                            <x-radio-input id="language_{{ $loop->index }}" name="language"
                                                :value="$language" :checked="old('language', $book->language) === $language" />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="year_of_publication" class="block mt-1 w-full" type="date"
                                        name="year_of_publication" :value="old('year_of_publication', $book->year_of_publication)"
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function updatePreview() {
                    ...
                    existingImagesArray.forEach((img, index) => {
                        ...
                        image.src = img.url;
                        image.alt = `Existing Image ${index + 1}`;
                ...
                function updateExistingImageInputs() {
                    const container = document.getElementById('existingImageIdsContainer');
                    container.innerHTML = '';
